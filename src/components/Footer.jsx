...
const Footer = () => {
  ...
  const inputStyle =
    'my-3 den w-60 border-slate-800 text-[12px] text-slate-800 border-solid border border-slate-400 placeholder:placeholder-custom-gray placeholder:text-[12px] px-4 py-1 rounded-md items-center focus:outline-none';

  const containerStyle = 'flex flex-col items-start gap-2';
  return (
    <div>
      <div className="bg-[#52527a] text-white items-start flex flex-col sm:flex-row gap-5 md:gap-1 justify-between px-2 md:px-8 py-2 md:py-8">
        ...
        <section className={containerStyle}>
          <h2 className="font-bold">Guideliness</h2>
          <Link className="text-xs font-bold hover:underline">For Authors</Link>
          <Link className="text-xs font-bold hover:underline">
            For Reviewers
          </Link>
          <Link className="text-xs font-bold hover:underline">For Editors</Link>
          <Link className="text-xs font-bold hover:underline">For Editors</Link>
          <Link className="text-xs font-bold hover:underline">
            For Librarians
          </Link>
        ...
        <section className={containerStyle}>
          ...
          <Link className="text-xs font-bold hover:underline">MDPI Books</Link>
          <Link className="text-xs font-bold hover:underline">
            Preprints.org
          </Link>
          <Link className="text-xs font-bold hover:underline">Scilit</Link>
          <Link className="text-xs font-bold hover:underline">SciProfiles</Link>
          <Link className="text-xs font-bold hover:underline">
            Encyclopedia
          </Link>
        ...
        <section className={containerStyle}>
          ...
          <Link className="text-xs font-bold hover:underline">Linkedn</Link>
